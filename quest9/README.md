...
Students often struggle to find quick, reliable answers to course-related questions. This chatbot provides instant, accurate responses and resources.

## Why This Template

The Azure OpenAI Chat Frontend template offers a ready-to-use, customizable chat UI that connects easily to AI-powered backends.

## Customizations

- Updated branding and prompts for education.
- (Optional) Connected to a custom backend with course data.
- (Optional) Changed the AI model or prompt engineering for better answers.

## How to Run

Follow the original instructions, or:
...
- [x] Problem statement
- [x] Template choice rationale
- [x] Customizations listed
