const globalConfig = {
  ...
  BRANDING_HEADLINE: 'Welcome to the Educational Q&A Assistant',
...
const teaserListTexts = {
  ...
  DEFAULT_PROMPTS: [
    { description: 'How do I prepare for the final exam?' },
    { description: 'What resources are available for topic X?' },
    { description: 'How can I contact my instructor?' },
  ],
};
